...
publishesRouter.get("/publishId/:publishId", getPublish)
publishesRouter.get("/token-uri/tokenId/:tokenId", tokenURI)
publishesRouter.get("/profile-contract", getProfileContract)

...
export interface FollowNFTInterface extends utils.Interface {
  ...
  events: {
    ...
    "Follow(tuple,address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "Follow"): EventFragment;
...
export type FollowEventFilter = TypedEventFilter<FollowEvent>;
